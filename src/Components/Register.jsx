...
import register from '../assets/register_01.jpg'
...
const Register = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-6 my-6'>
            <Helmet>
                <title>Electra Repair | Register</title>
            </Helmet>
            ...
            <div className='md:w-1/2 w-full '>
                <Slide damping={0.8} direction="right">
                    <div className='shadow-xl bg-gray-100 flex flex-col'>
                        ...
                        <h2 className="text-2xl font-bold text-center">Welcome to, Electra Repair</h2>
                        ...
                        <form onSubmit={handleRegister} className="card-body">
                            <div className="form-control">
                                ...
                                <div className=' relative'>
                                    <input type="text" placeholder="Name" name='name' className="input input-bordered w-full pl-12" required />
                            ...
                            <div className="form-control">
                                ...
                                <div className=' relative'>
                                    <input type="text" placeholder="Photo URL" name='photo' className="input input-bordered w-full pl-12" required />
                                    <div className='absolute top-1/3 left-3'>
