                ...
                <div className='shadow-xl rounded-lg bg-gray-100 flex flex-col p-4'>
                    ...
                    <form onSubmit={handleAddService} className="space-y-5">
                        <label className={theme==='sunset'?
                            ...
                            <input type="text" name="service" className="grow" placeholder="Service Name" required/>
                        ...
                        <label className={theme==='sunset'?
                            ...
                            <input type="text" name="area" className="grow" placeholder="Service Area"  required/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 opacity-70">
                        ...
                        <label className={theme==='sunset'?
                            ...
                            <input type="text" name="image" className="grow" placeholder="Image URL of the Service"  required/>
                        ...
                        <label className={theme==='sunset'?
                            ...
                            <input type="text" name="price" className="grow" placeholder="Price"  required/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <label className={theme==='sunset'?
                            ...
                            <input type="text" name="description" className="grow" placeholder="Description"  required/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
