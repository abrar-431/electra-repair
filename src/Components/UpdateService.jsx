...
import updateService from '../assets/add_service.jpg'
...
const UpdateService = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-6 my-6'>
            <Helmet>
                <title>Electra Repair | Update {service}</title>
            </Helmet>
            <div className='md:w-1/2 h-1/2 w-full overflow-hidden'>
                <Fade damping={0.5}>
                    <div className="shadow-xl z-10">
                        <img className='rounded-t-2xl ' src={updateService} alt="" />
            ...
            <div className='md:w-1/2 w-full my-0 md:my-16'>
                <Bounce>
                    <div className='shadow-xl rounded-lg bg-gray-100 flex flex-col p-4'>
                        ...
                        <hr className='w-1/4 mx-auto mt-2 bg-blue-800 border-0 h-1 rounded-full mb-4' />
                        <form onSubmit={handleUpdateService} className="space-y-5">
                            <div>
                                ...
                                <label className={theme === 'sunset'?
                                    ...
                                    <input type="text" name="service" defaultValue={service} className="grow" placeholder="Service Name" required />
                            ...
                            <span className={theme==='sunset'?
                                ...
                                <label className={theme === 'sunset'?
                                    ...
                                    <input type="text" name="area" defaultValue={area} className="grow" placeholder="Service Area" required />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 opacity-70">
                            ...
                            <span className={theme==='sunset'?
                                    ...
                                    :
                                    "label-text"
                                }>Image URL of the Service</span>
                                <label className={theme === 'sunset'?
                                    "input input-bordered input-info flex items-center gap-2 bg-gray-50"
                                    :
                                    "input input-bordered input-info flex items-center gap-2"
                                }>
                                    <input type="text" name="image" defaultValue={image} className="grow" placeholder="Image URL of the Service" required />
                            ...
                            <span className={theme==='sunset'?
                                ...
                                <label className={theme === 'sunset'?
                                    ...
                                    <input type="text" defaultValue={price} name="price" className="grow" placeholder="Price" required />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <span className={theme==='sunset'?
                                ...
                                <label className={theme === 'sunset'?
                                    ...
                                    <input type="text" name="description" defaultValue={description} className="grow" placeholder="Description" required />
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <div className="mt-6 w-1/2 mx-auto">
                                <AwesomeButton className='rounded-lg w-full' type="primary">Update</AwesomeButton>
                            </div>
                        </form>
                    </div>
                </Bounce>
